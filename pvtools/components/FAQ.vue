    ...
    data() {
      return {
        faqs: [
            ...
            text:"Um eine einfache Berechnung der Amortisation machen zu können, werdend diese Werte benötigt. Wenn du keine Einspeisevergütung bekommst, kannst du diese auf 0€ setzen."},
            {realm:"Eingabefelder",
            ...
            text:"Nachdem mindestens eine Ausrichtung eingetragen wurde, kann diese mit dem Mülleimer wieder entfernt oder mit dem Stift bearbeitet werden."},
            {realm:"Eingabefelder",
